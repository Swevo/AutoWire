        ...
        return context.SyntaxProvider
            .ForAttributeWithMetadataName(
                ...
                transform: static (ctx, _) =>
                {
                    ...
                    return new HttpClientInfo(ToFullyQualified(classSymbol), name, baseAddress, resilience);
                })
        ...
        string methodName)
    {
        ...
        if (!httpClients.IsEmpty)
        {
            ...
            foreach (var hc in httpClients.OrderBy(static h => h.ImplementationType))
            {
                ...
                {
                    clientChain = $"        services.AddHttpClient(\"{hc.Name}\", static c => c.BaseAddress = new global::System.Uri(\"{hc.BaseAddress}\"))\n            .AddTypedClient<{hc.ImplementationType}>()";
                }
                ...
                {
                    clientChain = $"        services.AddHttpClient<{hc.ImplementationType}>(static c => c.BaseAddress = new global::System.Uri(\"{hc.BaseAddress}\"))";
                }
