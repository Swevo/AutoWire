...
public sealed class AutoWireGenerator : IIncrementalGenerator
{
        ...
        DuplicateStrategy defaultStrategy)
    {
        ...
        if (classSymbol.IsGenericType)
        {
            ...
            return new RegistrationInfo(implName, serviceTypes.ToImmutableArray(), lifetime, keyExpression, true, duplicateStrategy, includeSelf, profile, isScanned: false, condition, includeLazy);
        }
